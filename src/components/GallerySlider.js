    ...
    return (
      <div className="gallery">
            ...
            return (
              ...
              >
                {image && (
                  <Image
                    background
                    src={`${image}-/format/auto/-/quality/lighter/-/progressive/yes/-/resize/500x/-/format/auto/-/quality/lighter/`}
                  />
                )}
                <ICONMagnify />
              </div>
        ...
        {gallery.map(({ image }, index) => {
          return (
            <div
              className={`galleryImage--Popup ${
                this.state.popupActive === index ? 'active' : ''
              }`}
              key={`image-full-${index}`}
            >
              <div
                className="galleryImage--Popup-Background"
              ...
              {image && (
                <Image
                  src={`${image}-/format/auto/-/quality/lighter/-/progressive/yes/-/resize/1000x/-/format/auto/-/quality/lighter/`}
                />
              )}
            </div>
          )
